...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/contractor-cash-flow`,               lastModified: SEO_2502 },
    { url: `${base}/job-costing-consultant`,             lastModified: SEO_2502 },
    { url: `${base}/remodeling-contractor-job-costing`,  lastModified: SEO_2502 },
    { url: `${base}/roofing-contractor-job-costing`,     lastModified: SEO_2502 },
